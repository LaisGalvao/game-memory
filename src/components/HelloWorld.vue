...
<div>
  ...
  id="jumbo-login" border-variant="dark">
    <template #header>
  ...
  <div class="container">
     ...
     <b-form-group>
        <b-form-input
          ...
          required
          description="Nós não compartilharemos seu email com terceiros."
        ></b-form-input>
     </b-form-group>
      <br>
      <b-form-group >
      ...
      <b-button class="btn-login" type="submit" 
      variant="primary" @click="login">Entrar</b-button>
    </div>

   <div>
     <br>
    <b-link class="form-link" href="">
      <router-link :to="{ path: '/register'}">
       Não possuo cadastro</router-link>
     </b-link>
    <br>
     <b-link class="form-link-danger">
       <router-link class="form-link-danger" :to="{ path: '/passrecover'}">
       Esqueci minha senha</router-link></b-link>
</div>
  </div>
</template>
...
#logo-login{
  background: url('../assets/game-memory.png');
